...
export class SearchComponent {
  ...
  suggestions = rxResource({
    ...
    loader: params => params.request.length >= MIN_SUGGEST_LENGTH
      ? this.http.get<string[]>(`${this.config.CONTENT_SERVICE}/search/suggest`, {params: {query: params.request}})
      : of([])
  });
  ...
  scopes: Record<Scope, SearchDataSource> = {
    local: new SearchDataSource(this.searchParams$,
      (page, pageSize, params) => {
        ...
        return this.http.get<Search.Result>(`${this.config.CONTENT_SERVICE}/search/diagram/${params.diagram}`, {
          params: {
            ...params,
            start: page * pageSize,
            rows: pageSize,
    ...
    global: new SearchDataSource(this.searchParams$,
      (page, pageSize, params) => {
        ...
        return this.http.get<Search.Result>(`${this.config.CONTENT_SERVICE}/search/fireworks/`, {
          params: {
            ...params,
            start: page * pageSize,
            rows: pageSize,
  ...
  selectedResultPathways = rxResource({
    ...
    loader: ({request}) => this.http.get<Search.Entry[]>(`${this.config.CONTENT_SERVICE}/search/pathways/of/${request}`, {
      params: {
        includeInteractors: false,
