...
export class EventService {
  ...
  private _TOP_LEVEL_PATHWAYS!: string;
  ...
  constructor(private http: HttpClient,
    ...
    this._TOP_LEVEL_PATHWAYS = `${this.config.CONTENT_SERVICE}/data/pathways/top/`;
    this._ANCESTORS = `${this.config.CONTENT_SERVICE}/data/event/`;
  }
